...
<head>
    ...
    <style>
        ...
        .day-column {
            background-color: #f9f9f9; /* Fondo predeterminado */
...
<body>
    <div class="container">
        <center><h1 class="mt-5">Generar/Actualizar Turnos modo Automático</h1></center>
        ...
        <form action="form_generar_turnos_aut.php" method="post" class="mt-4">
            ...
            <button type="submit" name="ver_empleados" class="btn btn-primary">Ver Empleados</button>
        </form>
    </div>
    ...
    <div class="container">
        ...
        <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['ver_empleados'])) {
                ...
                echo '<strong>Horas a Laborar Mes:</strong> ' . htmlspecialchars($horas_laborar);
                echo '</p>';
                echo '</div>';
                echo '</div>';
                ...
                // Determinar la clase para el estilo
                $class = ($es_festivo || $dias_semana[$dia_semana] == 'D') ? 'red-column' : 'day-column';
                echo "<th class='$class'><div class='day-header'>$day_display<br>" . $dias_semana[$dia_semana] . $label . "</div></th>";
                //echo "<th class='day-column'><div class='day-header'>$day_display<br>" . $dias_semana[$dia_semana] . $label . "</div></th>";
