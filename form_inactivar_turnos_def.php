...
<body>
    <div class="container mt-4">
        <h2>Inactivar Turnos Definitivos</h2>
        <form action="form_inactivar_turnos_def.php" method="POST"> <!-- Ajusta el action al archivo PHP de procesamiento -->
...
if ($validarDetalleMesResult->num_rows > 0) {
    ...
    echo "<script>alert('NO hay registros para procesar en el mes especificado'); window.location.href = 'form_inactivar_turnos_def.php';</script>";
    exit;
}
