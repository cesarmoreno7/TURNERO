...
<body>
    <div class="login-container">
        ...
        <br>
        <form action="validar_pwd.php" method="POST" class="needs-validation" novalidate>
            <!--<div class="form-group">
                <label for="codigo_usu">C&oacute;digo de usuario</label>
                <input type="text" class="form-control" id="codigo_usu" name="codigo_usu" placeholder="C&oacute;digo de usuario" required>
                <div class="invalid-feedback">Por favor, ingresa tu c&oacute;digo de usuario.</div>
            </div>-->
            <div class="form-group">
                <label for="clave_usu">Clave de Usuario</label>
                <div class="input-group">
                    <input type="password" class="form-control" id="clave_usu" name="clave_usu" placeholder="Ingrese Clave de Usuario" required>
            ...
            <input type="hidden" class="form-control" id="codigo_usu" name="codigo_usu" value ='<?php echo $codigo_usu;  ?>'>
            <!--<br>
            <a class="nav-link" href="enviar_mail.php">Enviar Mail de Prueba</a>-->
            
            <?php
            if (isset($_GET['error'])) {
                echo '<div class="alert alert-danger mt-3">Clave incorrecta o no encontrada</div>';
            }
            ?>
        </form>
    </div>
